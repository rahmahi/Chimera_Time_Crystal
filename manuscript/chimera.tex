...
\begin{figure*}[t!]
    \centering
    \includegraphics[width=13.5cm]{sz_t_strongweakJ_N_8.pdf}
...
\begin{figure}[t!]
	\begin{center}
		\includegraphics[width=15cm]{robust_J_N_8.pdf}
	\end{center}

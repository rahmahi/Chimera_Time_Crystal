...
\red{To investigate the impact of $\epsilon_B$ on the emergence of chimeralike state, we have considered the spin-1/2 chain with all sites initially populated with up-polarized spins. We have considered strong ($J_0 = 0.2/T$) and weak ($J_0 = 0.072/T$) spin-coupling interactions with drive frequency $\omega = 20$ and an amplitude corresponding to a CDT/DL point, maintaining constant $\epsilon_A=0.03$. We have obtained numerical results as well as a plot showing the change in local magnetization in course of time in figure~\ref{Fig:eb} for different spin-spin interaction ranges at each site (i) for two values of $\epsilon_B$ which is $\epsilon_B = 0.6$ and $\epsilon_B = 0.8$. For both of the $\epsilon_B$'s values, the DMBL phase in region B is found to lack of its stability in course of time, albeit the drive parameters are kept at CDT/DL point. This lack of stability in DMBL increases as $\epsilon_B$ decreases. Additionally, it has direct impact on the stability of DTC phase in region A, since the spins in region A interact with spins in region B. The DTC phase melts for all cases of $\epsilon_B$ and interaction ranges. However, rate of melting of DTC at different sites (i=0,1,2,3) varies depending on values of $\epsilon_B$ and interaction ranges.}

\red{ In general, each of the spins in the region A, exhibits similar dynamics over the course of time for all-to-all interaction range ($\beta=0$). In case of a particular spin rotational error and all-to-all spin coupling strength for all spins in region A, the melting of DTC phase  occurs at equal rates. For shorter interaction ranges, the spins of regions A, which are at away from the bipartite junction, achieve less interactions from region B, depending on the length of interaction. This results in faster local melting in DTC phase at the far away spins from the junction than the spins nearby to it. Additionally, the rate of melting of DTC at each site in region A, increases as length of spin coupling interaction decreases. This corroborates the better stability of chimeralike order in all-to-all interaction and when $\beta$ increases stability decays. For higher coupling strength, the rate of interaction increases. This explains that the chimeralike state melts faster in strong coupling interaction than weaker ones. Additionally, in shorter range interactions, at strong coupling strength due to increase in interaction between spins in DTC and DMBL phases, chimeralike state melts slower than weak coupling strength. In addition, we have observed that the rate of melting of DTC-DMBL chimeralike state is faster at smaller $\epsilon_B(=0.6)$ in comparison to higher $\epsilon_B(=0.8)$. Thus at smaller rotational error $\epsilon_B$, the DTC-DMBL chimeralike order is not sustainable for larger time period.}

\red{ Therefore we have considered a small $\epsilon_B = 0.3$ and a high $\epsilon_B = 0.9$ value to sustain a stable chimeralike state thorough out the manuscript. Also, a strong coupling is preferable to investigate the short time dynamics of DTC-DMBL chimeralike order.}

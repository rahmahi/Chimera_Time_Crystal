...
\end{figure}
The influence of the driving parameters $h, \omega$ significantly affects the long-lasting stability of the DTC-DMBL chimera\red{like order}. The stability of the chimera\red{like order} diminishes \sout{even if there is a minor} \red{at significant} deviation from the CDT/DL point. This raises questions about the mechanisms by which the chimera\red{like order} resists external fields, even while functioning precisely at the CDT/DL point.

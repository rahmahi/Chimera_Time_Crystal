...
\red{We have explored a vast region of spin rotation error ($\epsilon_{A/B}$) space to obtain a quantitative analysis on the stability of DTC-DMBL chimeralike order.}

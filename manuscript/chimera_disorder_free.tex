...
\blue{
	...
	\begin{align}
		...
		&=  \sin(\frac{2h}{\omega})\cos(\frac{2h}{\omega} \cos(\omega t)) - \cos(\frac{2h}{\omega})\sin(\frac{2h}{\omega} \cos(\omega t)).
		\label{eq:hmovap3}
	\end{align}	
	Fifthly,
	\begin{align}
		\sin(2\zeta) \cos(2\zeta)
		&=  \Bigg[\sin(\frac{2h}{\omega})\cos(\frac{2h}{\omega} \cos(\omega t)) - \cos(\frac{2h}{\omega})\sin(\frac{2h}{\omega} \cos(\omega t))\Bigg].\nonumber\\
		&\hskip 3cm \Bigg[\cos(\frac{2h}{\omega})\cos(\frac{2h}{\omega} \cos(\omega t)) + \sin(\frac{2h}{\omega})\sin(\frac{2h}{\omega} \cos(\omega t))\Bigg]\nonumber\\		
	...
	Sixthly,
	\begin{align}
	\cos[2](2\zeta) &= \Bigg[\cos(\frac{2h}{\omega})\cos(\frac{2h}{\omega} \cos(\omega t)) + \sin(\frac{2h}{\omega})\sin(\frac{2h}{\omega} \cos(\omega t))\Bigg]^2\nonumber\\
	&=\frac12 \Bigg[\cos\Big(\frac{4h}{\omega}\Big)\cos\Big(\frac{4h}{\omega}\cos(\oemga t)\Big) + \sin\Big(\frac{4h}{\omega}\Big)\sin\Big(\frac{4h}{\omega}\cos(\oemga t)\Big)\Bigg]
	\end{align}
	Seventhly,
	\begin{align}
		\sin[2](2\zeta) &=  \Bigg[\sin(\frac{2h}{\omega})\cos(\frac{2h}{\omega} \cos(\omega t)) - \cos(\frac{2h}{\omega})\sin(\frac{2h}{\omega} \cos(\omega t))\Bigg]^2\nonumber\\
		&= -\frac12 \Bigg[\cos\Big(\frac{4h}{\omega}\Big)\cos\Big(\frac{4h}{\omega}\cos(\oemga t)\Big) + \sin\Big(\frac{4h}{\omega}\Big)\sin\Big(\frac{4h}{\omega}\cos(\oemga t)\Big)\Bigg]
	\end{align}

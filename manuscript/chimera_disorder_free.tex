...
\begin{document}
	...
	\begin{multline}
		\hat{H}^{_{RWA}} = \hbar\sum_{ij} J_{ij} \Big(\hat{\sigma}^y_i\hat{\sigma}^y_j\Big) \Bigg[\Big\{\mathcal{J}_0\Big(\frac{4h}{\omega}\Big)\Big\}^2\\ + \frac{i}{2} (\hat{\sigma}^z_i + \hat{\sigma}^z_j) \mathcal{J}_0\Big(\frac{4h}{\omega}\Big)\sin\Big(\frac{4h}{\omega}\Big) \Bigg]
		\label{eq:movham1}
	\end{multline}
